...
// account
export const RECEIVE_ACCOUNT_SUCCESS = 'RECEIVE_ACCOUNT_SUCCESS';
...
export const RECEIVE_SURVEYS_SUCCESS = 'RECEIVE_SURVEYS_SUCCESS';
export const RECEIVE_SURVEYS_FAILURE = 'RECEIVE_SURVEYS_FAILURE';

// selected surveys
export const ADD_SELECTED_SURVEYS = 'ADD_SELECTED_SURVEYS';
export const REMOVE_SELECTED_SURVEYS = 'REMOVE_SELECTED_SURVEYS';
export const RECEIVE_DELETE_SURVEYS_SUCCESS = 'RECEIVE_DELETE_SURVEYS_SUCCESS';
export const RECEIVE_DELETE_SURVEYS_FAILURE = 'RECEIVE_DELETE_SURVEYS_FAILURE';
...
export const RECEIVE_CHANGE_ROLE_SUCCESS = 'RECEIVE_CHANGE_ROLE_SUCCESS';
export const RECEIVE_CHANGE_ROLE_FAILURE = 'RECEIVE_CHANGE_ROLE_FAILURE';
...
// subscribers
export const REQUEST_SUBSCRIBERS_LIST = 'REQUEST_SUBSCRIBERS_LIST';
export const RECEIVE_SUBSCRIBERS_SUCCESS = 'RECEIVE_SUBSCRIBERS_SUCCESS';
export const RECEIVE_SUBSCRIBERS_FAILURE = 'RECEIVE_SUBSCRIBERS_FAILURE';
export const REQUEST_ADD_SUBSCRIBERS = 'REQUEST_ADD_SUBSCRIBERS';
export const ADD_SUBSCRIBERS_SUCCESS = 'ADD_SUBSCRIBERS_SUCCESS';
export const ADD_SUBSCRIBERS_FAILURE = 'ADD_SUBSCRIBERS_FAILURE';
